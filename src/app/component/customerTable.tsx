...
import { Search, Filter, Plus, Download, MoreVertical, Eye, Edit, Trash2, ChevronLeft, Bell, UserMinus } from "lucide-react";
...
export default function CustomerDashboard() {
  ...
  const [previousPage, setPreviousPage] = useState("Overview"); // Track previous page for back navigation
  ...
  const goBack = () => {
    setActivePage(previousPage); // Navigate to the previous page
    setPreviousPage(""); // Reset to default previous page
  };

  return (
    <>
      <title>Kalavuna Restaurant</title>
      <div className="flex h-screen bg-gray-100 font-sans">
        {/* Sidebar */}
        <div className="w-64 bg-white shadow-lg h-full">
          <div className="p-6">
            <div className="flex items-center gap-3 mb-8">
              <button onClick={goBack} className="text-gray-400 hover:text-blue-600">
                <ChevronLeft className="w-6 h-6" />
              </button>
               <h1 className="text-md font-semibold text-blue-600">Kalavuna Restaurant</h1>
            </div>
                  ...
                  <div className="flex items-center gap-3">
                    <div className="relative">
                      ...
                      <input
                        ...
                        className="pl-10 pr-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 text-gray-500"
                      />
                    </div>
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      >
                        ...
                        <option value="London">Kigali</option>
                        <option value="New York">Rwamagana</option>
                        <option value="Paris">kayonza</option>
                        <option value="Virtual Space">Nyamata</option>
                      </select>
                    </div>
                    <div>
              ...
              <div className="bg-white rounded-lg shadow-lg p-6 w-full max-w-2xl">
                ...
                <div className="flex flex-col md:flex-row gap-6">
                  <div className="flex-shrink-0">
                    <Image
                      src={customers[showProfile - 1].avatar || "/images/profile.jpg"}
                    ...
                    <div className="mt-4 text-center md:text-left">
                      <label className="px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700 text-sm cursor-pointer">
                        <input type="file" accept="image/*" onChange={() => { setNewCustomer({ ...newCustomer, avatar: "/images/profile.jpg" }); customers[showProfile - 1].avatar = "/images/profile.jpg"; }} className="hidden" />
                        Upload
                      </label>
                      <button
