  ...
  return (
    <div className="bg-white min-h-screen flex">
      ...
      <aside className="w-64 bg-gray-50 p-6 border-r border-gray-200">
        <h2 className="text-xl font-bold text-gray-900 mb-6">Kalavuna Restaurant</h2>
        <nav className="space-y-2">
          <a href="#" className="flex items-center gap-2 p-2 text-gray-700 hover:bg-gray-200 rounded-lg">
            <span className="w-5 h-5">📊</span> Overview
          </a>
          <a href="#" className="flex items-center gap-2 p-2 text-blue-600 bg-gray-200 rounded-lg">
            <span className="w-5 h-5">👤</span> Customer List
          </a>
          <a href="#" className="flex items-center gap-2 p-2 text-gray-700 hover:bg-gray-200 rounded-lg">
            <span className="w-5 h-5">🍽️</span> Food Menu
          </a>
          <a href="#" className="flex items-center gap-2 p-2 text-gray-700 hover:bg-gray-200 rounded-lg">
            <span className="w-5 h-5">📦</span> Order
          </a>
          <a href="#" className="flex items-center gap-2 p-2 text-gray-700 hover:bg-gray-200 rounded-lg">
            <span className="w-5 h-5">💰</span> Sales
          </a>
          <a href="#" className="flex items-center gap-2 p-2 text-gray-700 hover:bg-gray-200 rounded-lg">
            <span className="w-5 h-5">💳</span> eWallet
          </a>
          <a href="#" className="flex items-center gap-2 p-2 text-gray-700 hover:bg-gray-200 rounded-lg">
            <span className="w-5 h-5">⭐</span> Reviews And Rating
          </a>
          <a href="#" className="flex items-center gap-2 p-2 text-gray-700 hover:bg-gray-200 rounded-lg">
            <span className="w-5 h-5">📣</span> Advertisement
          </a>
        </nav>
      </aside>
          ...
          {(showAddCustomer || showCustomerProfile) && (
            <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
              <div className="bg-white rounded-lg p-6 w-full max-w-md mx-4">
                {showAddCustomer ? (
                  <>
                    <h2 className="text-xl font-semibold mb-6 text-gray-800 border-b pb-2">Add New Customer</h2>
